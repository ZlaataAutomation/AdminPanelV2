...
public abstract class ManufactureReceive_ObjRepo extends BasePage {
    ...
    @FindBy(xpath = "(//li[normalize-space()='Manufacture Receive'])[1]")
    protected WebElement manufactureReceive;
}
