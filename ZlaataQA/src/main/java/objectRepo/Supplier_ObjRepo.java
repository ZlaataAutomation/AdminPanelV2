...
public abstract class Supplier_ObjRepo extends BasePage{
    ...
    @FindBy(xpath ="//a[@class='btn btn-primary'][normalize-space()='Create Supplier']")
    protected WebElement createSupplierbtn;
